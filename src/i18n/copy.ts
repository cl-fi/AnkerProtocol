...
export const enCopy = {
  ...
  dualInvestment: {
    ...
    btcPrice: 'BTC price',
    returnOverviewQuestion: (settle: string) => `Where will BTC land by ${settle}?`,
    returnOverviewQuestionFallback: 'Where will BTC land at settlement?',
    ...
    includesReward: (reward: string, meta: string) => `deposit back + ${reward} reward (${meta})`,
    outcomeBelowDetail: (targetPrice: string) => `you buy BTC at ${targetPrice} — the price you chose`,
    settles: 'Settles',
...
export const zhCnCopy: AppCopy = {
  ...
  dualInvestment: {
    ...
    btcPrice: 'BTC 价格',
    returnOverviewQuestion: (settle: string) => `到 ${settle}，BTC 会落在哪里？`,
    returnOverviewQuestionFallback: '结算时，BTC 会落在哪里？',
    ...
    includesReward: (reward: string, meta: string) => `本金返还 + ${reward} 收益（${meta}）`,
    outcomeBelowDetail: (targetPrice: string) => `以你选择的 ${targetPrice} 买入 BTC`,
    settles: '结算',
    testnetSettlementNote:
