...
export const enCopy = {
  ...
  portfolio: {
    ...
    rewardsSummary: (expected: string, cumulative: string) => `Expected ${expected} · Cumulative ${cumulative}`,
  ...
  wallet: {
    ...
    signOut: 'Sign out',
    network: 'Network',
    viewOnExplorer: 'View full history in explorer',
...
export const zhCnCopy: AppCopy = {
  ...
  portfolio: {
    ...
    rewardsSummary: (expected: string, cumulative: string) => `预期收益 ${expected} · 累计 ${cumulative}`,
