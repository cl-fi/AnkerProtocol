...
export const enCopy = {
  ...
  dualInvestment: {
    ...
    receiptReward: (meta: string) => `Reward (${meta})`,
    receiptTotal: 'Total',
  ...
  portfolio: {
    ...
    card: {
      ...
      settles: 'Settles',
      details: 'Details',
      outcomeAbove: (targetPrice: string, amount: string) =>
        `BTC at or above ${targetPrice} at settlement — you keep your deposit plus the reward: ${amount} dUSDC after fee.`,
      outcomeBelow: (targetPrice: string, btc: string) =>
        `BTC below ${targetPrice} — your deposit buys BTC at ${targetPrice}, the price you chose (≈ ${btc} BTC).`,
      outcomeTestnet:
      ...
      feeLabel: 'Fee',
      feeValue: (amount: string, pct: string) => `${amount} dUSDC (${pct} of the reward)`,
...
export const zhCnCopy: AppCopy = {
  ...
  dualInvestment: {
    ...
    receiptDeposit: '存入',
    receiptReward: (meta: string) => `收益（${meta}）`,
    receiptTotal: '合计',
  ...
  portfolio: {
    ...
    card: {
      ...
      details: '详情',
      outcomeAbove: (targetPrice: string, amount: string) =>
        `结算时 BTC 达到或高于 ${targetPrice}：拿回本金加收益，扣费后共 ${amount} dUSDC。`,
      outcomeBelow: (targetPrice: string, btc: string) =>
        `结算时 BTC 低于 ${targetPrice}：本金按你选择的 ${targetPrice} 买入 BTC（约 ${btc} BTC）。`,
      outcomeTestnet:
        '测试网上当前以 dUSDC 结算，而不是 BTC。如果 BTC 低于你的价格，你收到的现金可能略少于本金。主网上仓位将以真实封装 BTC 结算。',
      onChainProof: '链上证明',
      noteId: 'ProductNote ID',
      ...
      feeLabel: '费用',
      feeValue: (amount: string, pct: string) => `${amount} dUSDC（收益的 ${pct}）`,
